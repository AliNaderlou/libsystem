    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>اضافه کردن رشته تحصیلی</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="course_add.php">
                <div class="form-group">
                    <label for="code" class="col-sm-3 control-label">کد رشته</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="course_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_code" class="col-sm-3 control-label">کد  رشته</label>
