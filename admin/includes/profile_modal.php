    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">گذرواژه</label>
                ...
                <hr>
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">گدرواژه فعلی :</label>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-success btn-flat" name="save"><i class="fa fa-check-square-o"></i> ذخیره</button>
            	</form>
          	</div>
        </div>
    </div>
