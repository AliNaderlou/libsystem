	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
	        		<div class="box">
	        			<div class="box-header with-border">
	        				<h3 class="box-title">تاریخچه</h3>
	        				<div class="pull-right">
	        					<select class="form-control input-sm" id="transelect">
	        						<option value="borrow" <?php echo ($action == '') ? 'selected' : ''; ?>>امانت گرفته شده</option>
	        						<option value="return" <?php echo ($action == 'return') ? 'selected' : ''; ?>>پس داده شده</option>
	        					</select>
	    </div>
	        			</div>
	        			<div class="box-body">
